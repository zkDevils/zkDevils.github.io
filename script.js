document.addEventListener('DOMContentLoaded', function() {
    ...
    const scrollThreshold = 50; // Adjust this value to control the scroll threshold for the animation
    const overlaySpeed = 2.5; // Adjust this value to control the scrolling speed
